...
if(GENERATE_MESSAGESPOT)
  ...
  if(NOT XGETTEXT_EXECUTABLE)
    ...
    set(MESSAGES_POT_FILE ${PROJECT_SOURCE_DIR}/data/locale/messages.pot)
    add_custom_command(
    ...
    file(GLOB SUPERTUX_LEVEL_DIRS RELATIVE ${PROJECT_SOURCE_DIR} data/levels/*)
    foreach(SUPERTUX_LEVEL_DIR ${SUPERTUX_LEVEL_DIRS})
      file(GLOB SUPERTUX_LEVELS RELATIVE ${PROJECT_SOURCE_DIR} ${SUPERTUX_LEVEL_DIR}/*.stl ${SUPERTUX_LEVEL_DIR}/*.stwm ${SUPERTUX_LEVEL_DIR}/*.txt)

      ## Do not add target if SUPERTUX_LEVELS is empty. This is needed for cmake <=2.4
      if(SUPERTUX_LEVELS)
        set(MESSAGES_POT_FILE ${PROJECT_SOURCE_DIR}/${SUPERTUX_LEVEL_DIR}/messages.pot)
        add_custom_command(
          OUTPUT ${MESSAGES_POT_FILE}
          COMMAND ${XGETTEXT_EXECUTABLE}
